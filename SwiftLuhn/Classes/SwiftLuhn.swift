...
open class SwiftLuhn {
    ...
    fileprivate class func regularExpression(for cardType: CardType) -> String {
        ...
        case .rupay:
            return "^508[5-9][0-9][0-9]|60698[5-9]|60699[0-9]|607[0-8][0-9][0-9]|6079[0-7][0-9]|60798[0-4]|608[0-4][0-9][0-9]|608500|6521[5-9][0-9]|652[2-9][0-9][0-9]|6530[0-9][0-9]|6531[0-4][0-9]$"
        case .mir:
            return "^220[0-9]{13}$"
        }
    }
