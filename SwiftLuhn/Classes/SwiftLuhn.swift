...
open class SwiftLuhn {
    ...
    fileprivate class func regularExpression(for cardType: CardType) -> String {
        ...
        case .rupay:
            return "^508[5-9][0-9][0-9]{6,}|60698[5-9]{6,}|60699[0-9]{6,}|607[0-8][0-9][0-9]{6,}|6079[0-7][0-9]{6,}|60798[0-4]{6,}|608[0-4][0-9][0-9]{6,}|608500{6,}|6521[5-9][0-9]{6,}|652[2-9][0-9][0-9]{6,}|6530[0-9][0-9]{6,}|6531[0-4][0-9]{6,}$"
        case .mir:
            return "^220[0-9]{13}$"
        }
    }
